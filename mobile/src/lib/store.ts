...
interface TeamStore {
  ...
  addUnavailableDate: (playerId: string, date: string) => void;
  ...
  releaseScheduledGameInvites: () => Game[];
  ...
  createNewTeam: (teamName: string, sport: Sport, adminPlayer: Player) => string;
}
