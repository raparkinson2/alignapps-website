    ...
    <div className="min-h-screen bg-[#080c14] text-slate-100" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <section className="py-20 border-y" style={{ background: '#0d1526', borderColor: 'rgba(255,255,255,0.06)' }}>
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {[
              { label: 'iOS App', badge: 'Live on App Store', color: '#67e8f9' },
      ...
      <section className="py-24 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <p className="text-slate-400 mb-10 text-lg">Download the app or sign in to the web platform and get your team organized in minutes.</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              className="flex items-center gap-2.5 px-7 py-3.5 rounded-xl font-semibold text-[#080c14] bg-[#67e8f9] hover:bg-[#67e8f9]/90 transition-all text-sm"
            >
