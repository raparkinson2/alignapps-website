  ...
  return (
    <div className="min-h-screen bg-bg-base text-slate-100">
      <div className="max-w-2xl mx-auto px-6 py-24">
        ...
        <h2 className="text-lg font-bold mt-10 mb-3">Information We Collect</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-3">We collect information you provide directly, including:</p>
        ...
        <h2 className="text-lg font-bold mt-10 mb-3">How We Use Your Information</h2>
        <ul className="list-disc list-inside space-y-1 mb-6 text-slate-300 text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-bold mt-10 mb-3">Data Sharing</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-3">We do not sell your personal data. We share information only with:</p>
        <ul className="list-disc list-inside space-y-1 mb-6 text-slate-300 text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-bold mt-10 mb-3">Team Data Privacy</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-6">
        ...
        <h2 className="text-lg font-bold mt-10 mb-3">Data Retention</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-6">
        ...
        <h2 className="text-lg font-bold mt-10 mb-3">Children's Privacy</h2>
        <p className="text-slate-300 text-sm leading-relaxed mb-6">
        ...
        <h2 className="text-lg font-bold mt-10 mb-3">Contact Us</h2>
